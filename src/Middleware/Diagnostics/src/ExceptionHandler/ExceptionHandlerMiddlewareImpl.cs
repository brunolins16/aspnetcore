...
internal class ExceptionHandlerMiddlewareImpl
{
    ...
    private async Task HandleException(HttpContext context, ExceptionDispatchInfo edi)
    {
        ...
        try
        {
            ...
            var problemDetailsGenerated = false;
            if (_options.ExceptionHandler != null)
            {
            ...
            {
                problemDetailsGenerated = await _problemDetailsService!.TryWriteAsync(new()
                {
                    HttpContext = context,
            ...
            if (context.Response.HasStarted || problemDetailsGenerated || context.Response.StatusCode != StatusCodes.Status404NotFound || _options.AllowStatusCode404Response)
            {
