...
public abstract partial class FileResultBase
{
    private string? _fileDownloadName;

    /// <summary>
    /// Creates a new <see cref="FileResultBase"/> instance with
    ...
    /// <summary>
    /// Gets or sets the last modified information associated with the <see cref="FileResultBase"/>.
    /// </summary>
    public DateTimeOffset? LastModified { get; set; }

    /// <summary>
    /// Gets or sets the etag associated with the <see cref="FileResultBase"/>.
    /// </summary>
    public EntityTagHeaderValue? EntityTag { get; init; }

    /// <summary>
    /// Gets or sets the value that enables range processing for the <see cref="FileResultBase"/>.
    /// </summary>
